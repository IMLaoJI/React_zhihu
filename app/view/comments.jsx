...
import {getLongComments, getShortComments, getShortCommentsNext, showBox, hideBox, initComments,showloading } from '../redux/action'
...
const comments = React.createClass({
  ...
  render() {
    ...
    let {data,loaddingstatus} = this.props
    let {dispatch} = this.props
